...
## Triage (run at planning session start in Claude Chat)
1. Claude Chat pulls full backlog and presents as categorized table with suggested action per item
...
5. Discarded items: close GitHub issue, mark as discarded
6. v2.0 deferrals: move to v2.0 Deferred section
7. Workflow items get folded into CLAUDE.md or `.claude/rules/` directly — no GitHub issue
